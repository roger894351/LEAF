...
#script:python extract_count.py ../vcf/exomes/head.vcf test.txt nfe non_cancer,controls
...
with open(sys.argv[1],'r') as vcf:
    ...
    for line in vcf:
        if re.match("##",line):
            ...
            out.write("\t".join(['#CHROM','START','END','REF','ALT',prefix+'_AC_ref',prefix+'_AC_'+pop,prefix+'_AN'+pop,prefix+'_AF'+pop])+"\n")
        else:
            line=line.strip()
